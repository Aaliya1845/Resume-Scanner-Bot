...
# NOTE: nltk.download('punkt') and its error handling have been removed as per user request.
# Ensure 'punkt' tokenizer is available in your deployment environment if needed for other NLTK operations.
